import suitImg1 from "../Images/ThirdShirt.jpg";
import suitImg2 from "../Images/ThirdShirt2.jpg";
import NavigationVer2 from "../ElementsUI/NavigationVer2";
import classes from "./ThirdShirtPage.module.css";
import useSelectedLogic from "../CustomHooks/use-selected-logic";
import { motion } from "framer-motion/dist/framer-motion";

const ThirdShirtPage = () => {
  const {
    toggleLengthClass,
    selectedLength,
    toggleSizeClass,
      ...
      <div className={classes.suitDetailsArea}>
        ...
        <div className={classes.optionsArea}>
          <p className={classes.SuitName}>
            Women's Tie Navy Relaxed Fit Luxury Cotton Shirt
          </p>
          <span className={classes.codeArea}>
            <p className={classes.suitCode}>
              Item code: <span className={classes.code}>AS9S9US6ZY</span>
            </p>
            <p className={classes.saleOff}>25% off</p>
          </span>

          <p className={classes.suitBref}>Navy, Plain, Relaxed Fit</p>
          ...
          <span className={classes.suitSizes}>
            ...
            <div className={`${classes.size} ${classes.solid}`}>38 (EU 48)</div>
            <div
