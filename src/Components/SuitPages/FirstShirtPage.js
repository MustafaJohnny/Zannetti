import suitImg1 from "../Images/firstShirt.jpg";
import suitImg2 from "../Images/firstShirt2.jpg";
import NavigationVer2 from "../ElementsUI/NavigationVer2";
import classes from "./FirstShirtPage.module.css";
import useSelectedLogic from "../CustomHooks/use-selected-logic";
import { motion } from "framer-motion/dist/framer-motion";

const FirstShirtPage = () => {
  const {
    toggleLengthClass,
    selectedLength,
    toggleSizeClass,
        ...
        <div className={classes.optionsArea}>
          ...
          <span className={classes.codeArea}>
            <p className={classes.suitCode}>
              Item code: <span className={classes.code}>DR23DF1D0T</span>
            </p>
            <p className={classes.saleOff}>25% off</p>
          </span>

          <p className={classes.suitBref}>
            Navy & Pink, Geometric, Paisley, Fitted
          </p>
